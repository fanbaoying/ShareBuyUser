...
@implementation OrderTableViewHeaderView
...
- (UILabel *)statusLabel
{
    if (!_statusLabel) {
        _statusLabel = ({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(kScreenWidth/2, 5, kScreenWidth/2-10, 20)];
            [label setBackgroundColor:[UIColor clearColor]];
